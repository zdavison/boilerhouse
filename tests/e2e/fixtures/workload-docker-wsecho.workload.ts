...
// Inline Python WS echo server for e2e. Health check on :8080 (HTTP),
// WebSocket echo on :8081/ws. Uses only stdlib — no pip packages needed.
const serverScript = `
...
export default defineWorkload({
	...
	metadata: { description: "Python WebSocket echo server for Docker E2E testing" },
});
